...
STORE_DIR = FILE_DIR + 'lovely_girl_data/'
make_dir(STORE_DIR)
FILE_NAME = 'lovely_girl_48x48x3.npz'


def load_data():
    """
    萌妹子头像
    数据来源：https://zhuanlan.zhihu.com/p/26639135
    """
    try:
...
def __store_data():
    ...
    for (path, dirs, files) in os.walk('C:/Users/lenovo/Desktop/faces/girl_faces'):
